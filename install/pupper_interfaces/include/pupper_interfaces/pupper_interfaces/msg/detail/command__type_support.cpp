...
{
  new (message_memory) pupper_interfaces::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pupper_interfaces::msg::Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[1] = {
  {
    ...
    offsetof(pupper_interfaces::msg::Command, command),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  ...
  1,  // number of fields
  sizeof(pupper_interfaces::msg::Command),
...
{
  return &::pupper_interfaces::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, msg, Command)() {
  return &::pupper_interfaces::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
