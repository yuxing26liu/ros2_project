...
#include "pupper_interfaces/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pupper_interfaces::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pupper_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pupper_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  return &pupper_interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
