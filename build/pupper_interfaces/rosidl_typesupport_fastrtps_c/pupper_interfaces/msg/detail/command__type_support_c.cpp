...
#include "pupper_interfaces/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command__ros_msg_type = pupper_interfaces__msg__Command;
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pupper_interfaces__msg__Command(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pupper_interfaces__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pupper_interfaces__msg__Command(
