...
bool pupper_interfaces__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pupper_interfaces.msg._command.Command", full_classname_dest, 38) == 0);
  }
  pupper_interfaces__msg__Command * ros_message = _ros_message;
  {  // command
...
PyObject * pupper_interfaces__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pupper_interfaces.msg._command");
