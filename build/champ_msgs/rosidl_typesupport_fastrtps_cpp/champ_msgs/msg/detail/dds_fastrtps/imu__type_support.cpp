...
#include "champ_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const champ_msgs::msg::Imu & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  champ_msgs::msg::Imu & ros_message)
{
  // Member: orientation
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = champ_msgs::msg::Imu;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const champ_msgs::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<champ_msgs::msg::Imu *>(
    untyped_ros_message);
...
get_message_type_support_handle<champ_msgs::msg::Imu>()
{
  return &champ_msgs::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, champ_msgs, msg, Imu)() {
  return &champ_msgs::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
