...
#include "champ_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const champ_msgs::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  champ_msgs::msg::Pose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = champ_msgs::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const champ_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<champ_msgs::msg::Pose *>(
    untyped_ros_message);
...
get_message_type_support_handle<champ_msgs::msg::Pose>()
{
  return &champ_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, champ_msgs, msg, Pose)() {
  return &champ_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
