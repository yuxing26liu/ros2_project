...
static const _StopMusic_Request_type_support_symbol_names_t _StopMusic_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mini_pupper_interfaces, srv, StopMusic_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mini_pupper_interfaces, srv, StopMusic_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mini_pupper_interfaces, srv, StopMusic_Request)() {
  return &::mini_pupper_interfaces::srv::rosidl_typesupport_c::StopMusic_Request_message_type_support_handle;
}
...
static const _StopMusic_Response_type_support_symbol_names_t _StopMusic_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mini_pupper_interfaces, srv, StopMusic_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mini_pupper_interfaces, srv, StopMusic_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mini_pupper_interfaces, srv, StopMusic_Response)() {
  return &::mini_pupper_interfaces::srv::rosidl_typesupport_c::StopMusic_Response_message_type_support_handle;
}
...
static const _StopMusic_type_support_symbol_names_t _StopMusic_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mini_pupper_interfaces, srv, StopMusic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mini_pupper_interfaces, srv, StopMusic)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mini_pupper_interfaces, srv, StopMusic)() {
  return &::mini_pupper_interfaces::srv::rosidl_typesupport_c::StopMusic_service_type_support_handle;
}
