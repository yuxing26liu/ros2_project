...
bool mini_pupper_interfaces__srv__play_music__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mini_pupper_interfaces.srv._play_music.PlayMusic_Request", full_classname_dest, 56) == 0);
  }
  mini_pupper_interfaces__srv__PlayMusic_Request * ros_message = _ros_message;
  {  // file_name
...
PyObject * mini_pupper_interfaces__srv__play_music__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mini_pupper_interfaces.srv._play_music");
...
ROSIDL_GENERATOR_C_EXPORT
bool mini_pupper_interfaces__srv__play_music__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mini_pupper_interfaces.srv._play_music.PlayMusic_Response", full_classname_dest, 57) == 0);
  }
  mini_pupper_interfaces__srv__PlayMusic_Response * ros_message = _ros_message;
  {  // success
