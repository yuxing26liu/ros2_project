...
#include "mini_pupper_interfaces/srv/detail/stop_music__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mini_pupper_interfaces::srv::StopMusic_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mini_pupper_interfaces::srv::StopMusic_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mini_pupper_interfaces::srv::StopMusic_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mini_pupper_interfaces::srv::StopMusic_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mini_pupper_interfaces::srv::StopMusic_Request *>(
    untyped_ros_message);
...
{
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mini_pupper_interfaces, srv, StopMusic_Request)() {
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mini_pupper_interfaces
cdr_serialize(
  const mini_pupper_interfaces::srv::StopMusic_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mini_pupper_interfaces::srv::StopMusic_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mini_pupper_interfaces::srv::StopMusic_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mini_pupper_interfaces::srv::StopMusic_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mini_pupper_interfaces::srv::StopMusic_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mini_pupper_interfaces, srv, StopMusic_Response)() {
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic_Response__handle;
}
...
{
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mini_pupper_interfaces, srv, StopMusic)() {
  return &mini_pupper_interfaces::srv::typesupport_fastrtps_cpp::_StopMusic__handle;
}
