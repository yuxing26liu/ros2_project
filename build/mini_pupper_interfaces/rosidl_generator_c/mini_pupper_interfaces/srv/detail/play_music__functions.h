...
#ifndef MINI_PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
#define MINI_PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
 ...
 * calls
 * mini_pupper_interfaces__srv__PlayMusic_Request__init().
...
/**
 * It calls
 * mini_pupper_interfaces__srv__PlayMusic_Request__fini()
 ...
 * mini_pupper_interfaces__srv__PlayMusic_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mini_pupper_interfaces__srv__PlayMusic_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mini_pupper_interfaces__srv__PlayMusic_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mini_pupper_interfaces
...
/**
 * It calls
 * mini_pupper_interfaces__srv__PlayMusic_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mini_pupper_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mini_pupper_interfaces__srv__PlayMusic_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mini_pupper_interfaces
...
/**
 * It calls
 * mini_pupper_interfaces__srv__PlayMusic_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MINI_PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
